...
/* harmony import */ var react_howler__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react-howler */ "./node_modules/react-howler/lib/index.js");
/* harmony import */ var react_howler__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react_howler__WEBPACK_IMPORTED_MODULE_10__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function animate() {
  ...
  if (keys.right.pressed && player.position.x < 500) player.velocity.x = player.speed; //OR statements prevents the player to go behind start point
  else if (keys.left.pressed && player.position.x > 150 || keys.left.pressed && scrollOffset == 0 && player.position.x > 0) player.velocity.x = -player.speed; // when it hits edges, then we scroll background
    else {
        ...
        if (keys.right.pressed) {
          ...
          genericObject.forEach(function (genericObject) {
            genericObject.position.x -= player.speed * 0.50; //take less value than player speed so to get more realastic animation 
          });
